...
namespace Wards.UnitTests.Fixtures.Mocks
{
    ...
    {
        public static Log CriarLog(string tipoRequisicao, string endpoint, string parametros, string descricao, int statusResposta, int usuarioId)
        {
            Log log = new()
            {
        ...
        public static IEnumerable<Log> CriarListaLog()
        {
            List<Log> lista = new()
            {
                CriarLog(string.Empty, string.Empty, string.Empty, string.Empty, 0, 0),
                CriarLog(string.Empty, string.Empty, string.Empty, string.Empty, 0, 0)
            };
